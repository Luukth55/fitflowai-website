...
const SolutionsPage: React.FC = () => {
  ...
  const handleNextStep = () => {
    if (selectedServices.length === 0) {
      alert('Selecteer minimaal één AI-oplossing om door te gaan.');
      return;
    }
  ...
  return (
    <div className="min-h-screen bg-white">
            ...
            {selectedServices.length > 0 && (
              <div className="text-center mb-6">
                <p className="text-blue-600 font-medium">
                  {selectedServices.length} oplossing{selectedServices.length !== 1 ? 'en' : ''} geselecteerd
                </p>
              </div>
            )}
      ...
      {/* Aangepaste AI-oplossingen Section */}
      <section className="py-16 bg-gradient-to-br from-blue-50 to-cyan-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 leading-relaxed">
            Naast onze standaard AI-oplossingen, bieden wij bij FitFlow AI ook volledig op maat gemaakte AI-oplossingen die de wensen van de klant vervullen.
          </p>
        </div>
      </section>
    </div>
